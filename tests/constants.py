...
ARG_DICT = {
    ...
    "boss-runs-barcoded": ['--toml', f"{CONF_BASE}/BOSS_RUNS_barcode.toml", '--toml_readfish', f"{CONF_BASE}/BOSS_RUNS_RF_barcode.toml"],
    "boss-runs-sim-barcoded": ['--toml', f"{CONF_BASE}/BOSS_RUNS_SIM_barcoded.toml"],
